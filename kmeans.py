...
doctitle = ['title1', 'title2', 'title3', 'title4']
wordtitle = ['word1', 'word2', 'word3', 'word4', 'word5', 'word6', 'word7']
df = pd.DataFrame(sample_td_matrix, columns=doctitle, index=wordtitle)
